...
The migration may not change [ExtensionSequencer](ExtensionSequencer) mechanism, since that resolves the order of activating Selenium IDE extensions, and not the order of loading JS code modules.
...
See also [JavascriptComplex](JavascriptComplex) > [Operator instanceof and standard classes](JavascriptComplex#operator-instanceof-and-standard-classes).
